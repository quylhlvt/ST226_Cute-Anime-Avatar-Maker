package com.create.avatar.maker.ocdesgin.utils.share.whatsapp;
...
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.create.avatar.maker.ocdesgin.utils.share.whatsapp.StickerContentProvider";
