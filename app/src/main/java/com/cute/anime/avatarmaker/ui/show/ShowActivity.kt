...
class ShowActivity : AbsBaseActivity<ActivityShowBinding>() {
    ...
    private var remainingTimeMs = 300_000L // thời gian còn lại
    ...
    private fun startCountdown(timeMs: Long = remainingTimeMs) {
        ...
        countDownTimer = object : android.os.CountDownTimer(timeMs, 1_000L) {
            ...
            override fun onFinish() {
                ...
                val currentCacheFile = File(cacheDir, "show_preview_${System.currentTimeMillis()}.png")
    ...
    override fun onPause() {
        super.onPause()
        countDownTimer?.cancel() // dừng khi ẩn app
    }
...
//                    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_COSPLAY && resultCode == RESULT_OK) {
            ...
            // ✅ THÊM: Reset thời gian về ban đầu
            ...
            // ✅ THÊM: Đảm bảo canSave = true trước khi startCountdown
            canSave = true
            binding.btnSave.alpha = 1f
            startCountdown() // Lúc này remainingTimeMs đã là 300_000L
        }
    }
    override fun onResume() {
        super.onResume()
        // ✅ Chỉ chạy lại nếu còn thời gian, canSave = true,
        // VÀ không phải đang trong luồng onActivityResult (timer chưa được reset)
